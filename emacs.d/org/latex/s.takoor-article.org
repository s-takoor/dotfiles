...
#+LATEX_HEADER: \setlength{\columnsep}{\marginparsep}
...
#+LATEX_HEADER: \usepackage[a4paper, ignorehead, ignorefoot, top=2.5cm, bottom=2.5cm, left=2.5cm, right=2cm, footskip=2\baselineskip, footnotesep=0mm, marginparwidth=2.5cm, marginparsep=7mm, headheight=0mm,]{geometry}
...
#+LATEX_HEADER: \newcommand{\symmetricalPage}{\fancyhfoffset[L]{0mm}\newgeometry{ignorefoot, ignorehead, left=2.5cm, right=2cm, top=2.5cm, bottom=2.5cm, marginparwidth=0cm, marginparsep=0mm}}
...
% TITLE PAGE
#+LATEX_HEADER: \newcommand{\titlepagebackground}{\AddToShipoutPictureBG*{\AtPageLowerLeft{\includegraphics[width=\paperwidth,height=\paperheight]{titlepage.png}}}}
...
#+LATEX_HEADER: \setlength{\cftsecnumwidth}{2.5em}
#+LATEX_HEADER: \setlength{\cftsubsecindent}{3.5em}
#+LATEX_HEADER: \setlength{\cftsubsecnumwidth}{2.5em}
#+LATEX_HEADER: \renewcommand{\cfttoctitlefont}{\Large\bfseries}
#+LATEX_HEADER: \renewcommand{\cftsecfont}{\bfseries}
#+LATEX_HEADER: \renewcommand{\cftsubsecfont}{\normalfont}
#+LATEX_HEADER: \renewcommand{\cftsecpagefont}{\bfseries}
#+LATEX_HEADER: \renewcommand{\cftsubsecpagefont}{\normalfont}
