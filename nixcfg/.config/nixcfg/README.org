...
{ pkgs, ... }: {
  services.aerospace = {
    # BUG :: keeping disabled for now; https://github.com/LnL7/nix-darwin/issues/1142;
    # TODO :: to migrate to services.aerospace once issue resolved;
    # HACK :: used via homebrew for now;
    enable = false;
