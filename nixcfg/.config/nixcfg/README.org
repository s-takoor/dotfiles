...
| Org                                                                           |     1 |  1990 | 1513 |      224 |    253 |
| =============================================================================== |       |       |      |          |        |
| Total                                                                         |    53 |  3498 | 2644 |      454 |    400 |
| =============================================================================== |       |       |      |          |        |
...

{
  imports = [
    ...
    ./programs/mise
    ./programs/nix-index
    # ./programs/nixvim/default.nix # keeping disabled for now ( error: Alias @astrojs/language-server is still in node-packages.nix )
    ./programs/starship
    ./programs/thefuck
    ./programs/tmux
    ./programs/wezterm
...
***** NOTIFY
#+begin_src nix :tangle "~/.config/nixcfg/modules/home-manager/programs/nixvim/plugins/notify.nix" :mkdirp yes
{
